                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" name="titulo" value="{{ $produto->titulo }}">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input required type="number" class="form-control" name="estoque" value="{{ $produto->estoque }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input required type="number" class="form-control" name="preco" value="{{ $produto->preco }}">
                            </div>
                        </div>
                    </div>
